  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    <Bounce>
      <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-violet-900     text-violet-900">Designed for business teams like yours</h2>
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">Here at Online we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
      </Bounce>
      <Fade right>
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div className='shadow-lg p-5 bg-amber-100 border-2 border-violet-900'>
              ...
              <h3 className="mb-2 text-xl font-bold     text-violet-900">Assignments</h3>
          ...
          <div className='shadow-lg p-5 bg-amber-100 border-2 border-violet-900'>
              ...
              <h3 className="mb-2 text-xl font-bold     text-violet-900">Small Tasks</h3>
          ...
          <div className='shadow-lg p-5 bg-amber-100 border-2 border-violet-900'>
              ...
              <h3 className="mb-2 text-xl font-bold     text-violet-900">Long Term Projects</h3>
          ...
          <div className='shadow-lg p-5 bg-amber-100 border-2 border-violet-900'>
              ...
              <h3 className="mb-2 text-xl font-bold     text-violet-900">Finance Projects</h3>
          ...
          <div className='shadow-lg p-5 bg-amber-100 border-2 border-violet-900'>
              ...
              <h3 className="mb-2 text-xl font-bold     text-violet-900">Enterprise Design</h3>
          ...
          <div className='shadow-lg p-5 bg-amber-100 border-2 border-violet-900'>
              ...
              <h3 className="mb-2 text-xl font-bold     text-violet-900">Operations</h3>
